...
file_name = "Sunsports.csv"

SUNSPOT_CSV = "./"+dst+"/"+file_name
...
fetch_and_extract_zip(url, dst, filename=file_name)

with open(SUNSPOT_CSV, 'r') as csvfile:
...
# Open CSV file
with open(SUNSPOT_CSV) as csvfile:
