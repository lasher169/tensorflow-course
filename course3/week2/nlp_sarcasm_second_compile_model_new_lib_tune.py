...
# Train the model
history = model.fit(vectorized_training_sentences, training_labels, epochs=num_epochs, validation_data=(vectorized_testing_sentences, testing_labels), verbose=2)
