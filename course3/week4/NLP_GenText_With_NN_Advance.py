...
url = "https://docs.google.com/uc?export=download&confirm=t&id=15UqmiIm0xwh9mt0IYq2z3jHaauxQSTQT"
...
def fetch(url, extracted_dst):
    ...
    filename = os.path.join(extracted_dst, "irish-lyrics-eof.txt")
...
# Load the dataset
data = open(dst + '/irish-lyrics-eof.txt').read()
